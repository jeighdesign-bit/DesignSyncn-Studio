    ...
    <div className="lp-root">
      ...
      <nav className="lp-nav">
        ...
        <div className="lp-nav-actions">
          <a href="https://github.com/jeighdesign-bit/DesignSyncn-Studio" target="_blank" rel="noopener noreferrer" className="lp-github-badge">
            ...
            <div className="lp-github-divider" />
            <div className="lp-github-stars">
              <span className="stars-count">24,581</span>
            </div>
          </a>
